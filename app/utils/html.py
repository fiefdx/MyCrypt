...
class ThumbnailItem(object):
    ...
    """
    def __init__(self, title = "", url = "", excerpts = "", description = "", date_time = "", add_links = []):
        '''
        @summary: Init method
...
class ThumnailNote(object):
    """
        @summary: search result thumbnail representation
    """
    def __init__(self, url = "", noteid = "", notesha1 = "", file_title ="", file_content = "", created_at = "", updated_at = "", excerpts = "", description = "", notetype = "", add_links = []):
        '''
        @summary: Init method
...
def add_params_to_url(url, params):
    ...
    # print "yht-url_parts:", url_parts, type(url_parts)
    query = dict(urlparse.parse_qsl(url_parts[4]))
    # print "yht-query:", query, type(query)
    query.update(params)
    # print "yht-update-query:", query, type(query['q']), type(query['query'])
